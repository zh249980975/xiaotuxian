    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/index/category/${store.productDetail?.categories[1].id}` }">{{
            store.productDetail?.categories[1].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item
            :to="{ path: `/index/category/${store.productDetail?.categories[1].id}/sub/${store.productDetail?.categories[0].id}` }">{{
              store.productDetail?.categories[0].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item>{{ store.productDetail?.name }}</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!-- 商品信息 -->
          ...
          <div class="goods-info">
            <div class="media">
              ...
              <ul class="goods-sales">
                <li>
                  <p>销量人气</p>
                  <p> {{ store.productDetail?.salesCount }}+</p>
                  <p><i class="iconfont icon-task-filling"></i>销量人气</p>
                </li>
                <li>
                  <p>商品评价</p>
                  <p>{{ store.productDetail?.commentCount }}+</p>
                  <p><i class="iconfont icon-comment-filling"></i>查看评价</p>
                </li>
                <li>
                  <p>收藏人气</p>
                  <p>{{ store.productDetail?.collectCount }}+</p>
                  <p><i class="iconfont icon-favorite-filling"></i>收藏商品</p>
                </li>
                <li>
                  <p>品牌信息</p>
                  <p>{{ store.productDetail?.brand.name }}</p>
            ...
            <div class="spec">
              <!-- 商品信息区 -->
              <p class="g-name">{{ store.productDetail?.name }}</p>
              <p class="g-desc">{{ store.productDetail?.desc }}</p>
              <p class="g-price">
                <span>{{ store.productDetail?.price }}</span>
                <span>{{ store.productDetail?.oldPrice }}</span>
              </p>
              <div class="g-service">
                <dl>
                  <dt>促销</dt>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  <!-- 属性 -->
                  <ul class="attrs">
                    <li v-for="item in store.productDetail?.details.properties">
